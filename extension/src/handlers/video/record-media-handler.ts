    ...
    private async _recordAndForward(
        ...
        if (recordMediaCommand.message.record) {
            ...
            try {
                ...
                console.warn('[RecordMediaHandler] Audio start failed, continuing without audio', e);
        ...
        if (audioPromise) {
            ...
            try {
                ...
                if (e instanceof DrmProtectedStreamError) {
                    ...
                    console.warn('[RecordMediaHandler] Audio capture failed after start, continuing without audio', e);
