...
import { Message, UpdateStateMessage } from '@metheus/common';
import { createTheme } from '@metheus/common/theme';
import Snackbar from '@mui/material/Snackbar';
import Alert from '@mui/material/Alert';
import LogoIcon from '@metheus/common/components/LogoIcon';
                        ...
                        <Trans
                            ...
                            components={[
                                <Link
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    href={`https://github.com/GisaacPr/Metheus-Extension-/releases/tag/v${newVersion}`}
                                >
                                    release notes
                                </Link>,
                            ]}
