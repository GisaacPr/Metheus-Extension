...
import { AsbPlayerToVideoCommandV2, RequestSubtitlesMessage, RequestSubtitlesResponse } from '@metheus/common';
import TutorialBubble from '@metheus/common/components/TutorialBubble';
import { isFirefox } from '@metheus/common/browser-detection';
        ...
        <TutorialBubble
            ...
            text={
                <Trans
                    ...
                    components={[<b key={0}>Metheus</b>, <b key={1}>Popup</b>, <p key={2} />]}
            ...
            <DialogContent>
                ...
                {count === undefined && isMobile && (
                    <Trans
                        ...
                        components={[<b key={0}>Metheus</b>, <b key={1}>extensions</b>]}
                    />
                )}
            </DialogContent>
            {isFirefox && (
                ...
                <Trans
                    ...
                    components={[
                        ...
                        <Link href="https://docs.asbplayer.dev/docs/intro/" target="_blank" rel="noreferrer" key={2}>
                            {t('settings.userGuide', { defaultValue: 'user guide' })}
                        </Link>,
                    ]}
                />
            </DialogContent>
                        ...
                        <div style={{ width: isSmallScreen ? '100%' : '80%', maxHeight: '100dvh' }}>
                            <div style={{ position: 'relative', width: '100%', height: '100%', maxHeight: '100dvh' }}>
                                <video
                                    ...
                                    src={browser.runtime.getURL('/assets/tutorial.mp4' as any)}
