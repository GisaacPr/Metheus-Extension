...
import LoadSubtitlesIcon from '@metheus/common/components/LoadSubtitlesIcon';
...
const SidePanelHome = ({ videoElementCount, onLoadSubtitles, onShowMiningHistory }: Props) => {
    const { t } = useTranslation();
