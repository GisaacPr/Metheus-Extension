...
import { AsbplayerSettings, Profile } from '@metheus/common/settings';
import { humanReadableTime, download, extractText } from '@metheus/common/util';
import { AudioClip, Mp3Encoder } from '@metheus/common/audio-clip';
...
function App({
    ...
    const handleAnkiDialogProceed = useCallback((_data: any) => {}, []);
    ...
    const handleCopy = useCallback(
        ...
        [extension, miningContext, saveCopyHistoryItem, handleAnkiDialogProceed, t]
    );
