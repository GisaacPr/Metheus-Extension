...
import { AudioTrackModel, PlayMode, VideoTabModel } from '@metheus/common';
import { SubtitleAlignment } from '@metheus/common/settings';
        ...
        <React.Fragment>
            <Fade in={show} timeout={200}>
                <Grid
                    ...
                    style={{
                        position: 'absolute',
                        top: topOrBottom === 'top' ? 'auto' : 0,
                        bottom: topOrBottom === 'top' ? 0 : 'auto',
                    }}
                >
                    <Grid item>
                        {closeEnabled && (
            ...
            <div
                ...
                style={topOrBottom === 'top' ? { top: 0 } : { bottom: 0 }}
                onMouseOver={handleMouseOver}
                onMouseOut={handleMouseOut}
            >
                <Fade in={show} timeout={200}>
