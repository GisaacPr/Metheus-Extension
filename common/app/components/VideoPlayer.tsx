...
import { usePlayerChannel } from '../hooks/use-player-channel';
...
const showingSubtitleHtml = (
    ...
    if (subtitle.textImage) {
        const imageScale =
            (imageBasedSubtitleScaleFactor * (windowWidth > 0 ? windowWidth : window.screen.availWidth)) /
...
export default function VideoPlayer({
    ...
    const getSubtitleHtml = useCallback(
        ...
        [trackStyles, subtitleSettings.imageBasedSubtitleScaleFactor, settings.dictionaryTracks, windowWidth]
    );
    ...
    return (
        <div ref={containerRef} onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave} className={classes.root}>
            ...
            <Controls
                ...
                topOrBottom={subtitleAlignments[0] === 'bottom' ? 'top' : 'bottom'}
