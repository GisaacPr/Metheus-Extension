...
export const defaultSettings: AsbplayerSettings = {
    ...
    metheusUrl: process.env.NODE_ENV === 'production' ? 'https://metheus.app' : 'http://localhost:3000',
    metheusApiKey: '',
    metheusUserId: '',
    metheusToken: '', // deprecated, keep for backward compatibility
    metheusEnabled: true,
    metheusSyncKnownWords: true,
    metheusAutoExport: true,
    metheusTargetDeckId: '',
    metheusTargetLanguage: 'en',
    metheusNoteType: 'STANDARD',
    metheusGlobalHoverShortcut: 'ctrl+D',
    metheusOnlineDictionary: true,
};
...
const deepEquals = (a: any, b: any) => {
    ...
    // E-H5 FIX: Use Object.keys().length for object length comparison
