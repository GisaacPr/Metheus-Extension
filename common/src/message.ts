...
export interface DictionaryLookupMessage extends MessageWithId {
    readonly command: 'dictionary-lookup';
    readonly word: string;
    readonly language: string;
}

export interface DictionaryDownloadMessage extends MessageWithId {
    readonly command: 'dictionary-download';
    readonly language: string;
}

export interface DictionaryGetStatusMessage extends MessageWithId {
    readonly command: 'dictionary-get-status';
    readonly language: string;
}
...
export interface DictionaryOnlineEnrichMessage extends MessageWithId {
    readonly command: 'dictionary-online-enrich';
    readonly word: string;
    readonly language: string;
    /** Optional: query a specific provider by name instead of all providers */
