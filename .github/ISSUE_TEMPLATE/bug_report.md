...
https://github.com/GisaacPr/metheus-extension#common-issues
...
**Please provide logs from your developer console. At the very least, copy and paste the error from the "Copy Last Error" button (top-right) if the error is occuring in the Lingua Nova webapp.**
