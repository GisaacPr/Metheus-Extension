import { Fetcher } from '@metheus/common';
import { useChromeExtension } from '@metheus/common/app';
import RootApp from '@metheus/common/app/components/RootApp';
import { useMemo } from 'react';
import { AppExtensionSettingsStorage } from '@metheus/common/app/services/app-extension-settings-storage';
import { AppExtensionGlobalStateProvider } from '@metheus/common/app/services/app-extension-global-state-provider';
